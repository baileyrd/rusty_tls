...
**Not goals (yet):** session resumption, revocation, or any hand-rolled
...
## Non-goals
- **Session resumption, revocation, kTLS offload.** Out of scope for the
  MVP; add only if a named consumer needs one, the same consumer-gate
